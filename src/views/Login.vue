          ...
          <el-col :xs='15' :lg='4' :xl='3'>
            <div class='navigationContainer clearfix'>
              <div class='navigationColumn'>
                <div><font style='vertical-align: inherit;'><font style='vertical-align: inherit;'>还未注册？</font></font></div>
                <a id='retrieve' href='#'><font style='vertical-align: inherit;'><font style='vertical-align: inherit;'>忘记用户名或密码?</font></font></a>
              </div>
              <div class='navigationColumn'>
                <el-button type='primary' size='small' @click="goToRegister"><i class='el-icon-lock'></i>&nbsp;&nbsp;注册</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
      ...
      <el-main>
        <el-row type="flex" justify="center" >
          <div class='loginBox' :xs='24' :span='5' >
            <font class='create' style="vertical-align: inherit;"><font style="vertical-align: inherit;">登录帐号</font></font>
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-position="top">
              ...
              <el-form-item label="手机号码" prop="phoneNumber">
                <el-tooltip class="item" effect="dark" content="这会作为你的账号ID" placement="right">
                  <el-input v-model.number="ruleForm.phoneNumber" size="medium"></el-input>
                </el-tooltip>
              </el-form-item>
              <el-form-item label="密码" prop="password">
                <el-tooltip class="item" effect="dark" content="尽量避免简单密码" placement="right">
                  <el-input type="password" @input='confirm' v-model="ruleForm.password" autocomplete="off" :suffix-icon='lock' size="medium"></el-input>
                </el-tooltip>
              </el-form-item>
              ...
              <el-form-item>
                <el-row type="flex" justify="center"><el-button class='wideButton' type='primary' @click="submitForm('ruleForm')"><i class='el-icon-lock'></i>&nbsp;&nbsp;登录</el-button></el-row>
              </el-form-item>
            </el-form>
          </div>
        </el-row>
  ...
  methods: {
    ...
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          alert('submit!')
          this.$axios.post('http://127.0.0.1:8848/check', {
            'name': this.$refs.name,
            'pass': this.$refs.pass
